                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        ...
                                        <ul>
                                            ...
                                            <li>Hasta 500 registros de tu liga</li>
                                            <li>Hasta 500 registros de tu tienda</li>
                                            <li>Hasta 500 registros de pagos</li>
                                ...
                                <h5 class="card-title">Standar</h5>
                                    <p class="card-text">
                                        ...
                                        <ul>
                                            ...
                                            <li>Hasta 1000 registros de tu liga</li>
                                            <li>Hasta 1000 registros de tu tienda</li>
                                            <li>Hasta 1000 registros de pagos</li>
                                            <li>Hasta 10 tarifas de hora</li>
                                ...
                                <h5 class="card-title">Mega</h5>
                                    <p class="card-text">
                                        ...
                                        <ul>
                                            ...
                                            <li>Hasta 2000 registros de tu liga</li>
                                            <li>Hasta 2000 registros de tu tienda</li>
                                            <li>Hasta 2000 registros de pagos</li>

...
class PaginaOnce extends Web implements PaginaX
{
                ...
                <div class="m-4">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="descuentos-tab" data-bs-toggle="tab" data-bs-target="#descuentos" type="button" role="tab" aria-controls="descuentos" aria-selected="true">Descuentos</button>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="descuentos" role="tabpanel" aria-labelledby="descuentos-tab">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <canvas id="descuentosGraficaBarras">Your browser does not support the canvas element.</canvas>
                                </div>
                                <div class="col-md-6">
                                    <canvas id="descuentosGraficaLineas">Your browser does not support the canvas element.</canvas>
                                </div>
                                <div class="col-md-6">
                                    <canvas id="descuentosGraficaPolarArea">Your browser does not support the canvas element.</canvas>
                                </div>
                                <div class="col-md-6">
                                    <canvas id="descuentosGraficaPie">Your browser does not support the canvas element.</canvas>
                                </div>
                            </div>
    ...
    ?>
        ...
        <script src="resources/js/descuentosAdmin.js"></script>
    <?php
    }
}

$index = new PaginaOnce('Descuentos Administrador', '', '');
